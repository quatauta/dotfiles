(custom-set-variables
 ...
 '(TeX-check-path (quote ("./" "~/texmf" "/usr/share/texmf/bibtex/bst/" "/usr/share/texmf/tex/")))
 ...
 '(mmm-major-mode-preferences (quote ((perl cperl-mode perl-mode) (javascript javascript-mode c++-mode) (java jde-mode java-mode c++-mode) (css css-mode c++-mode) (php php-mode) (ruby ruby-mode))))
 '(mmm-mode-ext-classes-alist (quote ((html-mode "" embedded-css) (html-mode "\\.rhtml$" erb-code) (html-mode "" html-php) (html-mode "" html-js))) nil (mmm-mode))
 ...
 '(reftex-default-label-alist-entries (quote (AMSTeX amsmath endnotes fancybox floatfig longtable picinpar rotating sidecap subfigure supertab wrapfig LaTeX)))
 ...
 '(ruby-electric-simple-keywords-re "\\(def\\|if\\|class\\|module\\|unless\\|case\\|while\\|do\\|until\\|for\\|begin\\)")
 '(safe-local-variable-values (quote ((sh-basic-offset . 2) (sh-indentation . 2) (TeX-master . "vorlage"))))
 '(save-abbrevs nil)
 ...
 '(tab-width 8)
 '(text-mode-hook (quote (turn-on-auto-fill text-mode-hook-identify turn-on-filladapt-mode)))
 '(tool-bar-mode nil)
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:inherit nil :stipple nil :background "white" :foreground "black" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 90 :width normal :foundry "unknown" :family "Source Code Pro"))))
 ...
 '(custom-group-tag ((((class color) (background light)) (:inherit custom-documentation-face :foreground "blue" :weight bold :height 1.2))))
 '(diff-added ((((type x w32 mac) (class color)) (:inherit diff-changed :foreground "cyan4"))))
 '(diff-changed ((((type x w32 mac) (class color)) (:foreground "orange3"))))
 '(diff-context ((((type x w32 mac) (class color)) nil)))
 '(diff-file-header ((((type x w32 mac) (class color)) (:foreground "seagreen" :weight bold))))
 '(diff-function ((t (:inherit diff-context-face :slant italic))))
 '(diff-header ((((type x w32 mac) (class color)) (:background "seashell3" :weight bold))))
 '(diff-hunk-header ((((type x w32 mac) (class color)) (:inherit diff-header :foreground "brown"))))
 '(diff-removed ((((type x w32 mac) (class color)) (:inherit diff-changed :foreground "mediumpurple3"))))
 '(fixed-pitch ((t (:family "courier"))))
 '(flyspell-duplicate-face ((((class color)) (:inherit flyspell-incorrect-face :overline t))))
 ...
 '(fringe ((((type x w32 mac) (class color) (background light)) (:background "#e4e2d4" :foreground "#4e4c40"))))
 '(highlight ((((type x w32 mac) (class color) (min-colors 88) (background light)) (:background "#e4e2d4"))))
 '(highlight-current-line-face ((((type x w32 mac) (class color)) (:background "#dcd6c8"))))
 '(html-tag-face ((((type x w32 mac) (class color)) (:foreground "dodger blue"))))
 '(mode-line ((t (:inherit fringe :background "#e4e2d4" :foreground "#000000" :box (:line-width -1 :style released-button)))))
 '(mode-line-highlight ((((class color) (min-colors 88)) (:background "grey80"))))
 '(mode-line-inactive ((((type x w32 mac) (class color)) (:inherit mode-line :foreground "grey30" :weight light))))
